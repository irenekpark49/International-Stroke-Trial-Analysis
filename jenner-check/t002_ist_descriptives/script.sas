...
/* Descriptive-statistics section of the IST analysis: data prep, PROC FORMAT, and the
   PROC FREQ / PROC MEANS tables (overall and by treatment). Data is the same inline 100-row
   sample as the full-analysis bundle. */
